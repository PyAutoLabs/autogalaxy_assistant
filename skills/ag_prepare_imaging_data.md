...
The on-disk layout these files belong to is documented in
[`../wiki/core/operations/dataset.md`](../wiki/core/operations/dataset.md), grounded on the
bundled dataset and `autogalaxy_workspace:scripts/imaging/data_preparation/start_here.py`
