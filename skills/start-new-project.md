...
```json
{
  "run_id": "2026-06-19_imaging_ngc1300",
  "script": "scripts/imaging.py",
  "command": "python scripts/imaging.py --dataset ngc1300 --seed 42",
  "git_commit": "<project sha>", "git_dirty": false,
  "assistant": { "repo": "PyAutoLabs/autogalaxy_assistant", "commit": "<assistant sha>", "dirty": false },
  "environment_file": "environment.yml", "python_version": "3.11.x",
  "package_versions": { "autogalaxy": "<v>", "autofit": "<v>", "numpy": "<v>", "jax": "<v>" },
  "seed": 42,
  "inputs":  [{ "path": "dataset/reduced/ngc1300/data.fits", "sha256": "<hash>" }],
  "outputs": [{ "path": "results/figures/fit.png", "sha256": "<hash>" }],
  "started": "<iso8601>", "finished": "<iso8601>", "notes": "MGE baseline fit"
}
```
