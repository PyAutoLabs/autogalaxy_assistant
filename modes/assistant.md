...
Autonomy: "Model this galaxy end-to-end", "Decompose this galaxy into a bulge and disk and
report the structural parameters", "Run this project over several sessions and track
progress", "Analyse this sample and summarise the results."
